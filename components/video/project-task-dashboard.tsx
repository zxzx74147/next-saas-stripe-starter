...
export function ProjectTaskDashboard({
  ...
  const taskStats = {
    ...
    processing: project.videoTasks.filter((t) => t.status === "PROCESSING")
      .length,
    completed: project.videoTasks.filter((t) => t.status === "COMPLETED")
      .length,
    failed: project.videoTasks.filter((t) => t.status === "FAILED").length,
    totalCredits: project.videoTasks.reduce(
      (sum, task) => sum + task.creditsCost,
      0,
    ),
  };
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {taskStats.pending + taskStats.processing}
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              <CardContent>
                {latestTask ? (
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline">
                        {latestTask.creditsCost} credits
                      </Badge>
                    </div>
                    ...
                    <div className="mt-4 flex space-x-2">
                      <Button
                        ...
                        disabled={
                          isRefreshing ||
                          !["PENDING", "PROCESSING"].includes(latestTask.status)
                        }
                      >
                        {isRefreshing ? (
                  ...
                  <div className="py-4 text-center">
                    <Film className="mx-auto mb-4 size-12 text-muted-foreground" />
                    <p className="mb-4 text-muted-foreground">
                      No video tasks created yet
                    </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Project settings and configuration options will be displayed
                here.
              </p>
            </CardContent>
          </Card>
