    ...
    <Card className="mb-6">
      <CardHeader>
        <div className="flex justify-between items-start">
          <div>
            ...
            <CardDescription>
              Created on {format(new Date(task.createdAt), "MMMM d, yyyy 'at' h:mm a")}
            </CardDescription>
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="mt-1 font-medium line-clamp-2">{task.videoSettings.prompt}</p>
            </div>
            <div>
              <span className="text-muted-foreground">Duration:</span>
              <p className="mt-1 font-medium">{task.videoSettings.duration} seconds</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="mt-1 font-medium">{task.videoSettings.hasAdvancedEffects ? "Yes" : "No"}</p>
            </div>
            ...
            {task.videoSettings.aspectRatio && (
              <div>
                ...
                <p className="mt-1 font-medium">{task.videoSettings.aspectRatio}</p>
              </div>
            )}
          </div>
        </div>
      ...
      <CardFooter>
        <Button 
          ...
          disabled={isRefreshing || task.status === "COMPLETED" || task.status === "FAILED"}
          className="ml-auto"
        >
